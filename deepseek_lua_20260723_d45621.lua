-- ============================================
-- WANZZ PROJECT - BFG MULTIFARM (FINAL STABLE)
...
-- ============================================
-- FUNGSI FEED HOMELESS (SEPERTI INTERAKSI PENJUAL)
-- ============================================
local function FeedHomelessAtCoord(coord)
    ...
    -- Cari ProximityPrompt terdekat (tanpa filter)
...
local function ClaimPotatoChipsAndSell()
    ...
    -- Jika pot tidak tersedia, coba cari ulang
...
local function MainAutofarmController()
    ...
    while Configuration.Main_Settings.Autofarming do
        ...
        -- ================================
        -- 3. Persiapan potato chips (async) tapi kita tunggu hasil
        -- ================================
        ...
        task.spawn(function()
            ...
            BagPotato()
            MixFlourAndPotato()
            potFound = CookPotatoChips()  -- return boolean
            potatoPrepDone = true
        end)

        -- Countdown 20 detik sambil menunggu
        for i = 20, 1, -1 do
        ...
        -- Tunggu sampai persiapan selesai atau timeout 60 detik
        local waitStart = os.clock()
        while not potatoPrepDone and (os.clock() - waitStart) < 60 do
            task.wait(1)
        end

        -- Jika gagal mendapatkan pot, restart siklus
        ...
        -- Countdown 40 detik untuk marshmallow
        for i = 40, 1, -1 do
            if not Configuration.Main_Settings.Autofarming then break end
