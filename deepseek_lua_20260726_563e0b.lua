-- ============================================
-- AUTO FARM - MARSHMALLOW FARM + BUY MASK
...
MainSection:CreateToggle({
    Title = "Autofarming",
    Description = "Start/Stop the farm",
    Default = false,
    Callback = function(v)
...
MainSection:CreateToggle({
    Title = "Anti Death",
    Description = "Teleport to safe zone when low HP",
    Default = true,
    Callback = function(v)
...
MainSection:CreateToggle({
    Title = "Auto Rejoiner",
    Description = "Rejoin when stuck or die",
    Default = true,
    Callback = function(v)
...
local statusLabel = StatsSection:CreateLabel({
    Title = "📌 Status: Idle",
})
local runtimeLabel = StatsSection:CreateLabel({
    Title = "⏰ Runtime: 00:00:00",
})
local cashLabel = StatsSection:CreateLabel({
    Title = "💰 Cash: $0",
})
local marshLabel = StatsSection:CreateLabel({
    Title = "🧂 Marshmallows Sold: 0",
})
local rejoinLabel = StatsSection:CreateLabel({
    Title = "🔄 Times Rejoined: 0",
})
local cyclesLabel = StatsSection:CreateLabel({
    Title = "🔄 Cycles: 0",
})
