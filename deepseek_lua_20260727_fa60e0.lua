-- ============================================
-- LENGER MULTI FARM (FINAL FIX)
-- Perbaikan: Spawn bike (teleport awal + langsung naik),
-- UI tidak berubah ukuran, Statistik live, Stove handling
-- ============================================
...
-- ============================================
-- SPAWN & SIT ON BIKE (FIX: teleport awal + langsung naik)
-- ============================================
local function SpawnAndSitOnBike()
    ...
    -- === TETAP TELEPORT KE POSISI ANEH (SEPERTI SEMULA) ===
    ...
    -- === LANGSUNG DEKATI DRIVESEAT DAN INTERAKSI ===
...
MainWindow:SetSize(Vector2.new(500, 450))
