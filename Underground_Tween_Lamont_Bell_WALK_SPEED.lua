...
local DOWN_TIME = 4
local TRAVEL_SPEED = 12 -- studs/sec, kira-kira kecepatan jalan santai
local UP_TIME = 4
...
local function undergroundTeleport()
	...
	-- Kecepatan dihitung dari jarak, jadi gerakannya stabil
	-- seperti jalan biasa, bukan melesat/teleport.
	local travelDistance = (
		Vector3.new(undergroundTarget.X, 0, undergroundTarget.Z)
		- Vector3.new(undergroundStart.X, 0, undergroundStart.Z)
	).Magnitude

	local travelTime = math.max(travelDistance / TRAVEL_SPEED, 1)
