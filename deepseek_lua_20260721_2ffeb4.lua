-- ============================================
-- WANZZ PROJECT - BFG MULTIFARM (FIX BUG v4)
-- Logika siklus diperbaiki sesuai urutan:
-- 1. Spawn bike
-- 2. Cari & beli apartemen
-- 3. Beli bahan marshmallow
-- 4. Tuang air (tunggu 20 detik) sambil proses potato
-- 5. Tambah gula & gelatin (mulai masak marshmallow 40 detik)
-- 6. Card scam (beli fake ID, apply, tunggu approval, ambil kartu)
-- 7. Tunggu marshmallow selesai, kemas dan jual
-- 8. Ambil keripik dari pot, panaskan, beri makan homeless
-- 9. Ambil kartu & swipe ATM
-- ============================================
...
local function AddSugarAndGelatin()
    ...
    -- Setelah ini marshmallow mulai masak selama 40 detik
...
-- ============================================
-- MAIN AUTOFARM CONTROLLER (URUTAN DIPERBAIKI)
-- ============================================
...
local function MainAutofarmController()
    ...
    while Configuration.Main_Settings.Autofarming do
        ...
        -- Sambil menunggu air (20 detik), kita kerjakan potato chips
        ...
        -- 6. Card scam (beli fake ID, apply, tunggu approval ±35s, ambil kartu)
        ...
        -- Kemas dan jual marshmallow
        BagMarshmallowAndSell()

        -- 8. Ambil keripik dari pot, panaskan, beri makan homeless
        ClaimPotatoChipsAndSell()

        -- 9. Ambil kartu dan swipe ATM
        if Configuration.Main_Settings.EnableCardScam then
            ClaimAndUseCard()
        end

        -- Reset variabel pot (jika masih ada)
