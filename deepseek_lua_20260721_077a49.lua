...
-- Perbaikan:
--   - Proses potato tidak menghambat marshmallow
--   - Randomisasi pemilihan pot agar tidak stack
--   - Deteksi homeless dengan radius lebih besar
--   - Perbaikan waiting & claim pot (tidak interaksi terus)
-- ============================================
...
local function ClaimPotatoChipsAndSell()
    ...
    -- ===== FEED HOMELESS (DENGAN NPC TERDEKAT) =====
    local fedCount = 0
...
local function MainAutofarmController()
    ...
    while Configuration.Main_Settings.Autofarming do
        ...
        -- === CARD SCAM (opsional, berjalan paralel) ===
