...
-- ============================================
-- WANZZ PROJECT - BFG MULTIFARM (FIX BUG v7)
-- Perbaikan final: 
--   - ChipsCooking state untuk cegah pencarian pot berulang
--   - Urutan siklus: Water → Prepare Chips → Cook Chips → Sugar/Gelatin → Card Scam → Marshmallow → Claim Chips → ATM
...
local Random = Random.new()  -- pastikan Random tersedia, atau ganti math.random
...
-- ============================================
-- COOK POTATO CHIPS - DENGAN CEK ChipsCooking
-- ============================================
