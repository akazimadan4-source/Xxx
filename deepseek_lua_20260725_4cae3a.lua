...
-- ========================================
-- SKRIP UTAMA (Fungsionalitas Cheat)
-- ========================================
...
-- ========================================
-- PARTIKEL LATER (Opsional, untuk estetika)
-- ========================================
...
-- Buat tab
local AimbotTab = Window:Tab({ Name = "Aimbot", Image = "rbxassetid://18821914323" })
local ESPTab = Window:Tab({ Name = "ESP", Image = "rbxassetid://10734950309" })
local StaminaTab = Window:Tab({ Name = "Stamina", Image = "rbxassetid://18821914323" })
local InfoTab = Window:Tab({ Name = "Info", Image = "rbxassetid://10734950309" })

-- ========================================
-- TAB AIMBOT
-- ========================================
local AimbotSection = AimbotTab:Section({ Side = "Left" })
...
-- Aim Mode (PC/HP) sebagai Toggle
local modeToggle = AimbotSection:Toggle({
    Name = "Aim Mode: PC",
    Default = (AimMode == "PC"),
    Callback = function(state)
        AimMode = state and "PC" or "HP"
        modeToggle:UpdateName("Aim Mode: " .. AimMode)
    end,
})
...
-- TAB ESP
-- ========================================
local ESPSection = ESPTab:Section({ Side = "Left" })
...
-- TAB STAMINA
-- ========================================
local StaminaSection = StaminaTab:Section({ Side = "Left" })
...
InfoTab:Paragraph({
    Header = "LENGER HUB",
    Body = "Aimbot & ESP untuk game Anda.\nDibangun dengan MacLib.\n\nTekan RightControl untuk toggle UI."
})
