...
-- if not AvailablePot or Configuration.State.ChipsCooking == false then return end

-- ============================================
-- WANZZ PROJECT - BFG MULTIFARM (FIX BUG v6)
-- Perbaikan logika siklus:
--   - Urutan diperbaiki: Water → Prepare Chips → Cook Chips → Sugar/Gelatin → Card Scam → Marshmallow → Claim Chips → ATM
--   - State ChipsCooking untuk mencegah pencarian pot berulang
--   - Sugar/Gelatin hanya dijalankan jika ChipsCooking true
--   - Reset state setelah claim chips
-- ============================================
...
-- ============================================
-- KONFIGURASI (tambah ChipsCooking, MarshmallowCooking, CurrentStep)
-- ============================================
local Configuration = {
    Main_Settings = {
        Autofarming = false,
    ...
    State = {
        ...
        ChipsCooking = false,           -- <--- TAMBAH
        MarshmallowCooking = false,     -- <--- TAMBAH
        CurrentStep = "START",          -- <--- TAMBAH
    },
}
...
-- ============================================
-- MODIFIKASI: AddSugarAndGelatin dengan pengecekan ChipsCooking
-- ============================================
local function AddSugarAndGelatin()
    WaitForReady()
    -- Cek apakah chips sudah dimasak
...
-- ============================================
-- COOK POTATO CHIPS - DIPERBAIKI DENGAN CEK ChipsCooking
-- ============================================
...
-- ============================================
-- CLAIM & FEED HOMELESS - DIPERBAIKI (RESET STATE)
-- ============================================
local function ClaimPotatoChipsAndSell()
    ...
    -- RESET STATE SETELAH CLAIM (baik sukses atau gagal)
    AvailablePot = nil
    PotPrompt = nil
    PotTimer = nil
    Configuration.State.ChipsCooking = false
...
-- ============================================
-- MAIN AUTOFARM CONTROLLER (URUTAN BARU)
-- ============================================
