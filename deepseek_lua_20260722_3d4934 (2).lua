...
-- ============================================
-- STEALTH TELEPORT (KECEPATAN LAMBAT - SEMULA BAGUS)
-- ============================================
local function DirtBikeTeleportStealth(TargetPosition)
    ...
    if distance > 30 then
        -- KECEPATAN LAMBAT (SEPERTI MODIFIKASI AWAL)
...
local function MainAutofarmController()
    ...
    while Configuration.Main_Settings.Autofarming do
        ...
        -- ===== MODIFIKASI: KEMBALIKAN JEDA 2 DETIK AGAR PROSES POTATO CHIPS AMAN =====
        task.wait(2)  -- <-- DIKEMBALIKAN
