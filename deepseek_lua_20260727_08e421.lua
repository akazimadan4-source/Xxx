...
local function CookPotatoChips()
    ...
    -- Ensure apartment and teleport to stove
...
-- ============================================
-- UI MENGGUNAKAN AETHER LIBRARY (DIPERBAIKI)
-- ============================================
...
local MainWindow = Library:CreateWindow({
    Title = "LENGER MULTI FARM",  -- Ganti nama
    SubText = "Stealth",
...
-- Membuat label dengan metode update yang handal
local function CreateLabel(section, initialText)
    ...
    if section.AddLabel then
        ...
        -- fallback ke AddTextBox read-only
    ...
    -- Bungkus dengan fungsi update yang mencoba berbagai cara
    local labelObject = {
        _label = label,
        Update = function(self, newText)
            ...
            elseif lbl.Value ~= nil then
                ...
                -- jika tidak ada, coba langsung assign ke properti
