-- ============================================
-- BFG BETA - MULTI FARM (FIX BUG POT)
-- Perbaikan: Teleport ke stove setelah pot ditemukan
-- ============================================

if getgenv().BFG_BETA_LOADED then return end
getgenv().BFG_BETA_LOADED = true
...
task.spawn(function()
    ...
    local function UpdateStats()
        ...
        pcall(function()
            ...
            cashLabel:SetText("💰 Cash: $" .. GetCommaValue(currentCash))
            chipsLabel:SetText("🍟 Chips Fed: " .. Configuration.Statistics.ChipsFed)
            marshLabel:SetText("🧂 Marshmallows Sold: " .. Configuration.Statistics.MarshmallowsSold)
            rejoinLabel:SetText("🔄 Times Rejoined: " .. Configuration.Statistics.TimesRejoined)
