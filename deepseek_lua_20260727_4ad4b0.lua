-- ============================================
-- LENGER STORE - MULTI FARM (FIX BUG POT + UI)
-- Perbaikan: Teleport ke stove, UI update dengan Set()
-- ============================================
...
-- Label-label statistik (gunakan Set() untuk update)
...
-- ============================================
-- UPDATE STATISTICS (menggunakan Set)
-- ============================================
task.spawn(function()
