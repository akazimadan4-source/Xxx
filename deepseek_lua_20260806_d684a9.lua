-- ============================================
-- LENGER MULTI FARM (FIX TELEPORT)
-- Perbaikan: teleport tidak turun dari motor, 
--           pengecekan occupant setelah pivot.
-- ============================================
...
-- ============================================
-- DIRTBIKE TELEPORT (FIX: TIDAK TURUN)
-- ============================================
local function DirtBikeTeleport(TargetPosition)
    ...
    -- Jika masih tidak duduk, paksa teleport karakter ke kursi
    if not DriveSeat.Occupant then
