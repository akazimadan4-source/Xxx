...
-- Perbaikan: Tidak cari pot ulang, UI Paragraph
-- ============================================
...
-- ============================================
-- CLAIM & FEED HOMELESS (DIPERBAIKI - TIDAK PAKAI TIMER)
-- ============================================
local function ClaimPotatoChipsAndSell()
    ...
    -- Tunggu masak selesai (120 detik) atau jika ada timer text, gunakan itu
    local potTimer = nil
...
local function MainAutofarmController()
    ...
    while Configuration.Main_Settings.Autofarming do
        ...
        -- ================================
        -- 4. Pastikan apartemen masih valid
        -- ================================
        if not EnsureApartment() then
