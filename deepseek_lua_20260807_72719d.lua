-- WAVEX HUB - Full UI dengan Tab System, Slider, Dropdown, Snow Particles
-- Original CloudWare Style (Modified & Cleaned)
...
SnowFrame.Size = UDim2.new(1, 0, 1, -38)
SnowFrame.Position = UDim2.new(0, 0, 0, 38)
...
local function CreateTab(TabName)
    ...
    Btn.Text = TabName
    Btn.TextColor3 = Color3.fromRGB(82, 82, 96)
...
local function SwitchTab(TabData)
    ...
    if CurrentTab then
        ...
        CurrentTab.Btn.TextColor3 = Color3.fromRGB(82, 82, 96)
    ...
    TabData.Btn.BackgroundColor3 = Color3.fromRGB(22, 22, 28)
end

-- Update tab positions
task.defer(function()
    local TotalTabs = #Tabs
    local TabWidth = 420 / TotalTabs
...
local function CreateToggle(Parent, Label, Default, Callback)
    ...
    ToggleBtn.Size = UDim2.new(0, 54, 0, 24)
...
local function CreateSlider(Parent, Label, Min, Max, Default, Callback)
    ...
    SliderFill.BackgroundColor3 = Color3.fromRGB(60, 200, 200)
...
local function CreateDropdown(Parent, Label, Options, Default, Callback)
    ...
    DropBtn.Size = UDim2.new(0.35, 0, 1, -4)
    DropBtn.Position = UDim2.new(0.6, 0, 0, 2)
    ...
    DropdownFrame.Position = UDim2.new(0.6, 0, 0, 32)
    ...
    for _, Option in ipairs(Options) do
        ...
        OptionBtn.BackgroundColor3 = Color3.fromRGB(25, 25, 30)
        OptionBtn.Text = Option
        OptionBtn.TextColor3 = Option == Selected and Color3.fromRGB(60, 200, 200) or Color3.fromRGB(180, 180, 180)
        ...
        OptionBtn.MouseButton1Click:Connect(function()
            ...
            for _, Btn in pairs(DropdownFrame:GetChildren()) do
                if Btn:IsA("TextButton") then
                    Btn.TextColor3 = Btn.Text == Option and Color3.fromRGB(60, 200, 200) or Color3.fromRGB(180, 180, 180)
                end
            end
        end)
    end
    ...
    DropBtn.MouseButton1Click:Connect(function()
        ...
        DropdownFrame.Size = UDim2.new(0.35, 0, 0, #Options * 24 + 4)
    end)
end
...
CreateSection(AimbotContent, "KEYBINDS")
CreateToggle(AimbotContent, "Aimbot Key: E", true, function(v) 
    if v then _G.AimbotKey = Enum.KeyCode.E else _G.AimbotKey = nil end
end)
...
CreateSection(WhitelistContent, "WHITELIST (TEMAN)")
...
-- ==================== TAB: CONFIG ====================
local ConfigContent = TabConfig.Content
CreateSection(ConfigContent, "CONFIG")
...
local function CreateConfigButton(Label, Color, Callback)
    local Btn = Instance.new("TextButton")
...
CreateConfigButton("💾 Save Config", Color3.fromRGB(35, 90, 50), function()
    Notify("Config", "Config saved successfully!", 2)
end)

CreateConfigButton("📂 Load Config", Color3.fromRGB(35, 55, 100), function()
    Notify("Config", "Config loaded successfully!", 2)
end)

CreateConfigButton("🔄 Reset All", Color3.fromRGB(100, 35, 35), function()
    Notify("Reset", "All settings reset to default!", 2)
end)

CreateConfigButton("📋 Copy Config", Color3.fromRGB(70, 60, 20), function()
    setclipboard("WAVEX HUB Config Data")
    Notify("Copied", "Config copied to clipboard!", 2)
end)
...
print("❄️ Full UI with Tabs, Slider, Dropdown, Snow Particles")
