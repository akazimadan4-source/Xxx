...
local function FeedHomelessAtCoord(coord)
    ...
    -- Cari ProximityPrompt terdekat (mirip dengan pencarian penjual)
    ...
    -- Jika tidak ada prompt, cari NPC Homeless
    ...
    -- Verifikasi sukses (Hot Chips berkurang atau habis)
    task.wait(0.5)
    ...
    if not remaining then
        ...
        -- Anggap berhasil karena prompt sudah difire
