...
local function CreateUI()
    ...
    local StaminaBtn = ToggleBtn("[OFF] Infinite Stamina", 230, Color3.fromRGB(30, 30, 60), Color3.fromRGB(0, 200, 100))
    local ModeBtn = ToggleBtn("Mode: PC", 270, Color3.fromRGB(20, 30, 80), Color3.fromRGB(80, 20, 50))
    ...
    StaminaBtn.MouseButton1Click:Connect(function()
        ...
        StaminaBtn.Text = Stamina and "[ON] Infinite Stamina" or "[OFF] Infinite Stamina"
