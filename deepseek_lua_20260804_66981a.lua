-- ========================================
-- LENGER HUB - SIMPLE UI (NO EXTERNAL LIBRARY)
-- ========================================
...
-- ========================================
-- UI DENGAN LAYOUT GRID (2 KOLOM)
-- ========================================

local function CreateUI()
    local ScreenGui = Instance.new("ScreenGui")
    ScreenGui.Parent = Player:WaitForChild("PlayerGui")
    ScreenGui.Name = "LENGERHub"
    ...
    -- Helper function to create toggle button with custom position and size
    local function ToggleBtn(text, x, y, width, defaultColor, onColor)
    ...
    -- Create buttons in grid layout (2 columns, 3 rows)
    -- Row 1: FOV (kiri) dan AIM (kanan)
    local FOVBtn = ToggleBtn("[ON] FOV Circle", 0.05, 70, 0.40, Color3.fromRGB(0, 150, 100), Color3.fromRGB(0, 200, 100))
    local AimBtn = ToggleBtn("[OFF] Silent Aim", 0.55, 70, 0.40, Color3.fromRGB(150, 30, 30), Color3.fromRGB(0, 200, 100))

    -- Row 2: WALL (kiri) dan ESP (kanan)
    local WallBtn = ToggleBtn("[OFF] Wallbang", 0.05, 110, 0.40, Color3.fromRGB(30, 30, 60), Color3.fromRGB(0, 200, 100))
    local ESPBtn = ToggleBtn("[OFF] ESP", 0.55, 110, 0.40, Color3.fromRGB(30, 30, 60), Color3.fromRGB(0, 200, 100))

    -- Row 3: Mode (lebar penuh)
    local ModeBtn = ToggleBtn("Mode: PC", 0.075, 150, 0.85, Color3.fromRGB(20, 30, 80), Color3.fromRGB(80, 20, 50))
