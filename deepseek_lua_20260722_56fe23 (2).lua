...
task.spawn(function()
    ...
    local function UpdateStats()
        ...
        pcall(function()
            -- Perbarui dengan SetDesc (tanpa judul)
            ...
            chipsLabel:SetDesc(tostring(Configuration.Statistics.ChipsFed))
            marshLabel:SetDesc(tostring(Configuration.Statistics.MarshmallowsSold))
            rejoinLabel:SetDesc(tostring(Configuration.Statistics.TimesRejoined))
            hotChipsLabel:SetDesc(tostring(CountHotChips()))
            cyclesLabel:SetDesc(tostring(Configuration.Statistics.CyclesCompleted))
            cardsSwipedLabel:SetDesc(tostring(Configuration.Statistics.CardsSwiped))
        end)
    end
