-- ============================================
-- LENGER MULTI FARM (MODIFIED with Multi Farm logic for Potato & Homeless)
-- Perbaikan: Spawn bike, teleport, potato workflow, homeless interaction
-- ============================================
...
-- ============================================
-- DAFTAR KOORDINAT HOMELESS (12 TITIK) - tetap
-- ============================================
...
-- ============================================
-- CLAIM POTATO CHIPS & FEED HOMELESS (dengan interaksi Multi Farm)
-- ============================================
local function ClaimPotatoChipsAndSell()
    ...
    -- Feeding Homeless (gaya Multi Farm)
    ...
    while Configuration.Main_Settings.Autofarming and fedCount < maxFeedingAttempts do
        ...
        -- Cari prompt terdekat (seperti sebelumnya)
        ...
        if not bestPrompt then
            Configuration.State.Status = "[FEED] No prompt near coord"
        ...
        -- Equip Hot Chips (gaya Multi Farm)
        ...
        if not remaining then
            Configuration.State.Status = "[FEED] Success"
            fedCount = fedCount + 1
