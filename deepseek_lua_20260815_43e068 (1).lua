...
local WaterStat = AddStat(AutoTab, "Water", 2)
local SugarStat = AddStat(AutoTab, "Sugar Block Bag", 3)
local GelatinStat = AddStat(AutoTab, "Gelatin", 4)
local EmptyBagStat = AddStat(AutoTab, "Empty Bag", 5)

AddLabel(AutoTab, "CONTROL", 6)

local StatusFrame = AddCard(AutoTab, 40, 7)
...
-- Keybind to toggle GUI (Left Control + L)
...
-- Make sure GUI is visible and on top
MainFrame.Visible = true
MainFrame.ZIndex = 10
ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Global

print("LENGER STORE loaded successfully!")
print("Press Left Control + L to toggle GUI")