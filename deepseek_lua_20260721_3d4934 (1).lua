...
local function DirtBikeTeleportStealth(TargetPosition)
    ...
    if distance > 30 then
        -- Ubah steps dan jeda agar lebih pelan
        local steps = math.min(math.floor(distance / 15), 10) -- lebih banyak langkah agar halus
        for i = 1, steps do
            ...
            task.wait(0.2) -- jeda lebih lama (0.2 detik)
        end
    end
    pcall(function()
