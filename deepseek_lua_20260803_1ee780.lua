-- ============================================
-- LENGER MULTI FARM (BRUTE-FORCE RPC)
-- Mencari remote secara otomatis tanpa nama folder tetap.
-- ============================================
...
local function findSpawnRemote()
    -- Kumpulkan semua remote di ReplicatedStorage
    local remotes = {}
    ...
    -- Urutkan berdasarkan kemungkinan nama
    ...
    -- Coba setiap remote dengan pcall
    ...
    -- Jika tidak ada yang berhasil, coba dengan string biasa
    for _, remote in pairs(remotes) do
        local success, err = pcall(function()
...
-- ============================================
-- SPAWN & SIT BIKE (pakai remote yang ditemukan)
-- ============================================
...
local function BuySkiMask()
    ...
    -- Cari StorePurchase di sekitar ReplicatedStorage
...
Library:Notify({
    Title = "LENGER MULTI FARM",
    Lifetime = 3,
    Text = "Script loaded! Remote ditemukan: " .. RPC.Name
})