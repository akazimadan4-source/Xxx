    ...
    LPH_JIT_MAX(function()
        ...
        if Game_Name == "South Bronx" then
            ...
            HideUI = LPH_NO_VIRTUALIZE(function(Title, Timing)
                ...
                textLabel.Text = '<font color="rgb(0,163,224)">WAVEX</font> HUB\n' .. Title
...
local window = library:window({name = "WAVEX", suffix = " HUB", gameInfo = string.format("LENGER STORE : %s", Game_Name:lower())})
