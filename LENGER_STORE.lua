...
if isfunctionhooked then
    if isfunctionhooked(FireServer) or isfunctionhooked(UnreliableFireServer) or isfunctionhooked(InvokeServer) and LPH_OBFUSCATED then
        return Services.LocalPlayer:Kick("LENGER STORE | Security : You are running another script, please disable it and execute again")
    end
end
    ...
    LPH_JIT_MAX(function()
        ...
        if Game_Name == "South Bronx" then
            ...
            HideUI = LPH_NO_VIRTUALIZE(function(Title, Timing)
                ...
                textLabel.Text = '<font color="rgb(0,163,224)">LENGER STORE</font> HUB\n' .. Title
...
local window = library:window({name = "LENGER STORE", suffix = " HUB", gameInfo = string.format("LENGER STORE : %s", Game_Name:lower())})
...
button.MouseButton1Click:Connect(function()
    if setclipboard then
        setclipboard("https://discord.gg/M7SQjcP9k")
    elseif toclipboard then
        toclipboard("https://discord.gg/M7SQjcP9k")
    end
    button.Text = "Copied!"
end)
